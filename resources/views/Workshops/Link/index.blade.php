              ...
              <div class="row py-3">
                  ...
                  <div class="col-3 d-flex justify-content-center">
                    <div class="d-flex flex-row">
                      <div style="cursor: pointer;" data-bs-toggle="modal" data-bs-target="#edit" onclick="edit({{$link->id}}, '{{$link->link}}')">
                      ...
                      <!-- delete -->
                      <div style="cursor: pointer;" data-bs-toggle="modal" data-bs-target="#hapus" onclick="hapus({{$link->id}})">
          ...
          <div class="modal-content p-4">
            ...
            <div class="modal-body">
              <form method="post" id="hapusLink">
                ...
                <p id="hd" style="color: black; font-weight: bold">Apakah anda yakin ingin menghapus link ini ?</p>
