  ...
  <div class="container">
    <div class="col-lg-12">
      ...
      <div class="upper my-3">
        ...
        <div class="search">
          <input type="address" name="address" class="align-self-end" placeholder="Search" autocomplete="on" required>
        </div>
      </div>
      <div class="tabel first-service">
        ...
        <div class="row py-3">
          ...
          <div class="col-6 tanggal">
            <p>www.loremipsumdotsilerametdolorloremipsum.com</p>
          </div>
          <div class="col-3 d-flex justify-content-center">
            <div class="d-flex flex-row">
              <div style="cursor: pointer;" data-bs-toggle="modal" data-bs-target="#editWorkshop">
